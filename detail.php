...
MercadoPago\SDK::setAccessToken('TEST-59aeb270-99fd-4443-9598-a8feabdeb312');
...
$preference->back_urls = array(
    "success" => "https://raviolex-mp-commerce-php.herokuapp.com/success.php",
    "failure" => "https://raviolex-mp-commerce-php.herokuapp.com/failure.php",
    "pending" => "https://raviolex-mp-commerce-php.herokuapp.com/pending.php"
);

// Crea un ítem en la preferencia
$item = new MercadoPago\Item();
$item->picture_url =  "https://raviolex-mp-commerce-php.herokuapp.com/".$_POST['img'];
                        ...
                        <div class="pd-billboard pd-category-header">
                            <div class="pd-l-plate-scale">
                                ...
                                <div class="pd-billboard-info">
                                    <h1 class="pd-billboard-header pd-util-compact-small-18">Tiennda e-commerce</h1>
                                </div>
                            </div>
                        </div>
                    </div>
