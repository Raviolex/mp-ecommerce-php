...
define('URL', 'https://raviolex-mp-commerce-php.herokuapp.com');
...
$preference->back_urls = [
    ...
    'failure' => URL.'/result.php?s=failure&ref='.$reference,
